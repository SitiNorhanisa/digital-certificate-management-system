...
<body>
    ...
    <div class="row" id="body-row">
        ...
        <div class="col p-4 mt-3">
            ...
            <div class="card mt-2">
                <h5 class="card-header font-weight-light">Program(s) Information</h5>
                <div class="card-body">
                    <div class="row margin-bottom-10" style="overflow-x:auto;">
                        <table class="mt-3 table table-striped" id="listProg">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table class="table table-striped" id="prog_detail">
