...
<body>
    ...
    <div class="row" id="body-row">
        ...
        <div class="col p-4 mt-3">
            ...
            <div class="card">
                <h5 class="card-header font-weight-light">Upload CSV file</h5>
                <div class="card-body">
                    <div class="row margin-bottom-10">
                        <div class="col-md-12 text-center">
                            <div class="col-sm-12" style="text-align: left">
                                <h6>Please download and follow the template given in csv format.</h6>

                                </br>
                                <a href="../assets/files/sample.csv" download><button class="btn btn-primary " id="downloadSample">Download Template <i class="fa fa-download" aria-hidden="true"></i></button></a>
                            </div>
                            <form class="col-mt-5" id="upload_form" method="POST" enctype="multipart/form-data">
                                <div>
                                    ...
                                    <input type="text" class="form-control" id="eventName" value="<?php echo $eventName; ?>" style="text-align: center;" readonly />
                                    <input type="text" class="form-control" id="eventID" value="<?php echo $eventID; ?>" readonly style="display: none;" />
                                </div>
                                </br>
                                <div class="mt-5 ">
                                    <input type="file" id="csvfile" class="form-control" name="csvfile" required="required" accept=".csv" />

                                </div>

                                <div class="mt-5 ">
                                    <button type="submit" class="btn btn-info " id="upload">Upload CSV <i class="fas fa-upload"></i></button>
                                </div>
                                <div id="msg"></div>
                            </form>
                        </div>
                ...
                <div class="card-body">
                    <div class="row margin-bottom-10">
                        <div class="col-md-12" style="overflow-x:auto;">
                            <h3 class="alert-warning p-2 text-center">Participants' Information</h3>
                            <table class="mt-3 table table-striped" id="data-table">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" id="update_form">
                            ...
                            <input type="text" name="rcp_name" id="rcp_name" class="form-control inputText" onkeyup="this.value = this.value.toUpperCase()" />
                            <br />
                            <label>NRIC/Passport</label>
                            <input type="text" name="rcp_nric" id="rcp_nric" class="form-control"></input>
                            <br />
                            <label>Matric No.</label>
                            <input type="text" name="matric_no" id="matric_no" class="form-control" onkeyup="this.value = this.value.toUpperCase()"></input>
                            <br />
                            <label>Email</label>
    ...
    <script src="../Controller/uploadCSVController.js"></script>
    <script>
        function goBack() {
