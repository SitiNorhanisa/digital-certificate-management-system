...
<body>
    ...
    <div class="row" id="body-row">
        ...
        <div class="col p-4 mt-3">
            ...
            <div class="card">
                <h5 class="card-header font-weight-light">Participant Data</h5>
                <div class="card-body">
                    <div class="row margin-bottom-10">
                        <div class="col-md-12">
                            <h6>Please choose your action.</h6>
                        </div>
                        <div class="col-md-12 text-center">
                            <div class="mt-5">
                                <a type="submit" class="btn btn-primary btn-lg active" id="btnFileRcp" href="uploadCSV.php?id=<?php echo $eventID; ?>">Import File</a>
                            </div>
                            <div class="mt-5">
                                <a type="submit" class="btn btn-primary btn-lg" id="btnSingleRcp" href="singleInput.php?id=<?php echo $eventID; ?>">Single Input</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <form class="col-md-12" id="addEventForm" style="display: none;">
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="eventName" name="newEventName" placeholder="Run For Unity (RFU)">
                            </div>

                            <div class="col">
                                <label for="eventDate">Date of Event</label>
                                <input type="date" class="form-control" id="eventDate" name="eventDate" placeholder="Date of Event">
                            </div>
                            <div class="col">
                                <label for="eventVenue">Venue of Event</label>
                                <input type="text" class="form-control" id="eventVenue" name="eventVenue" placeholder="Eg: Stadium Azman Hashim">
                            </div>
                            <div class="col">
                                <label for="eventSession">Session</label>
                                <input type="text" class="form-control" id="eventSession" name="eventSession" placeholder="Eg: 2020/2021">
                            </div>
                        </div>
                        <br>
                        <button type="submit" class="btn btn-primary mb-2 float-right" id="addEventBtn">Add</button>
                    </form>
                </div>
                <!-- list of event -->
