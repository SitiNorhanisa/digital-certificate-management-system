...
<body>
    ...
    <div class="row" id="body-row">
        ...
        <div class="col p-4 mt-3">
            ...
            <div class="card">
                <h5 class="card-header font-weight-light">Download the certificate(s) in PNG</h5>
                <div class="card-body">
                    <div class="row margin-bottom-10" id="pngCard">
                        <h6>Only approved certificates will be downloaded in ZIP format.</h6>
                        <table class="table" id="tablePNG">
                            <thead>
                                <tr>
            ...
            <div class="card" id="emailCard" style="display: none;">
                <h5 class="card-header font-weight-light">Email</h5>
    ...
    <script src="../Controller/downloadController.js"></script>
</body>
